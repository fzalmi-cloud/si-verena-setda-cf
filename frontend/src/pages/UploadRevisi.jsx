                    ...
                    <div className="space-y-1 max-h-32 overflow-y-auto">
                      {dokumenList.map((dok, i) => (
                        <div key={dok.id} className="flex items-center gap-2 text-xs py-1 px-2 rounded-lg bg-muted/40">
                          ...
                          {dok.file_url && (
                            <a href={getFileUrl(dok.file_url)} target="_blank" rel="noopener noreferrer" className="text-primary hover:opacity-70">
                  ...
                  <div>
                    ...
                    <div className="p-3 space-y-2">
                      ...
                      {dokumenAwal?.file_url && (
                        <a href={getFileUrl(dokumenAwal.file_url)} target="_blank" rel="noopener noreferrer"
                  ...
                  <div>
                    ...
                    <div className="p-3 space-y-2">
                      ...
                      {dokumenTerbaru?.file_url && (
                        <a href={getFileUrl(dokumenTerbaru.file_url)} target="_blank" rel="noopener noreferrer"
                          className="flex items-center gap-1 text-[10px] text-primary hover:underline">
                          <ExternalLink className="w-3 h-3" /> Buka dokumen
                        </a>
                      )}
